/* QR Code generator bundle
 * Based on Kazuhiko Arase's QRCode for JavaScript (MIT License).
 * Bundled locally for SafeOS Community; no network request is required.
 */
(function(global){
  'use strict';
  const factories = {}; const cache = {};
  function define(name, factory){ factories[name]=factory; }
  function localRequire(name){
    if(cache[name]) return cache[name].exports;
    if(!factories[name]) throw new Error('QR module not found: '+name);
    const module={exports:{}}; cache[name]=module; factories[name](module,module.exports,localRequire); return module.exports;
  }
...
module.exports = QRCode;
  ...
  global.QRCodeModel=localRequire('./index');
  global.QRErrorCorrectLevel=localRequire('./QRErrorCorrectLevel');
})(window);
